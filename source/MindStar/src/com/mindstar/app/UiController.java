...
import com.mindstar.FragmentChangeActivity;
import com.mindstar.library.util.Constants.ACTIVITY_STATES;
...
public class UiController{
	...
	public void handleEvent(Activity fromActivity, byte toActivityId,
		...
		case ACTIVITY_STATES.MAIN_APP:
			intent = new Intent(fromActivity, FragmentChangeActivity.class);
			break;

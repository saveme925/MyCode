...
public class ClickListenerForSelectEmail implements OnClickListener {

	private ImageView m_selectedState;
	private Context m_context;
	private EmailModel m_model;
	private DBHelper m_dbh;

	public ClickListenerForSelectEmail(ImageView p_selectState,
			Context p_context, EmailModel p_model, DBHelper p_dbh) {
